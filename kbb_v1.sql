...
--
-- Hôte : 127.0.0.1
-- Généré le :  ven. 29 mars 2019 à 12:04
...
(36, 'test', '2019-03-25 10:20:48', 0, 136, 1),
(42, 'test', '2019-03-25 13:16:59', 0, 131, 1),
(43, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque sapien velit, aliquet eget commodo nec, auctor a sapien. Nam eu neque vulputate diam rhoncus faucibus. Curabitur quis varius libero. Lorem.', '2019-03-26 09:27:42', 0, 145, 1),
(44, 'ezrezrzerzer', '2019-03-28 15:19:39', 0, 137, 1);
...
(1, 'admin', 'admin@kidsbreizhBirthday.fr', '$2y$10$aAKag5gKEkUGdN5ceijkK.5nXigHs2yUA/m4DomOCjvKEPcqII6xC', 'assets/img/webFiles/1553689270myAvatar.png', 2, '2019-02-21 16:06:23'),
...
--
ALTER TABLE `alert`
  ADD CONSTRAINT `ALERT_ANNONCES_FK` FOREIGN KEY (`id_ANNONCES`) REFERENCES `annonces` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `ALERT_COMMENTAIRES_FK` FOREIGN KEY (`id_COMMENTAIRES`) REFERENCES `commentaires` (`id`),
  ADD CONSTRAINT `ALERT_MEMBRES_FK` FOREIGN KEY (`id_MEMBRES`) REFERENCES `membres` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `annonces`
--
ALTER TABLE `annonces`
  ADD CONSTRAINT `ANNONCES_MEMBRES_FK` FOREIGN KEY (`id_MEMBRES`) REFERENCES `membres` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `commentaires`
--
ALTER TABLE `commentaires`
  ADD CONSTRAINT `COMMENTAIRES_ANNONCES_FK` FOREIGN KEY (`id_ANNONCES`) REFERENCES `annonces` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `selection`
  ADD CONSTRAINT `SELECTION_ANNONCE_FK` FOREIGN KEY (`id_ANNONCES`) REFERENCES `annonces` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `SELECTION_MEMBRES_FK` FOREIGN KEY (`id_MEMBRES`) REFERENCES `membres` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `votes`
--
ALTER TABLE `votes`
  ADD CONSTRAINT `VOTE_ANNONCES_FK` FOREIGN KEY (`id_ANNONCES`) REFERENCES `annonces` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `VOTE_MEMBRES_FK` FOREIGN KEY (`id_MEMBRES`) REFERENCES `membres` (`id`) ON DELETE CASCADE;
COMMIT;
