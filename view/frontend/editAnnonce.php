...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            <form class="form-horizontal" role="form" method="POST" action="index.php?action=editThisAnnonce&id_ANNONCES=<?=$ann['id']?>"
                enctype="multipart/form-data" id="editannonce">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="5" maxlength="600" required name="presentation"  ><?= $ann['presentation']?></textarea>
                </div>
                <div class="form-group">
                    <label for="contenu">Descriptif des activités proposées (maxi 500 caracters)</label>
                    <textarea class="form-control" rows="5" maxlength="600" required name="descriptif"><?=$ann['descriptif']?></textarea>
                </div>
                <div class="form-group"> 
